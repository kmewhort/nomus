/*
 * 
 * ContentWordFrequencyMeasure.java, provides keyword/keyphrase extraction as a GATE plugin
...
public class ContentWordFrequencyMeasure extends RelevanceMeasure implements
		LexicalRelevanceMeasure {

	private static Logger logger = Logger.getLogger(ContentWordFrequencyMeasure.class
			.getName());
