/*
 * 
 * LogLikelihoodMeasure.java, provides keyword/keyphrase extraction as a GATE plugin
...
public class LogLikelihoodMeasure extends RelevanceMeasure implements
		LexicalRelevanceMeasure {

	private static Logger logger = Logger.getLogger(LogLikelihoodMeasure.class
			.getName());
