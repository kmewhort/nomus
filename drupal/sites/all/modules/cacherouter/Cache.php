<?php
// $Id: Cache.php,v 1.1.2.17 2010/08/20 21:36:19 andypost Exp $
...
class CacheRouterEngine {
  ...
  function __construct($bin, $options, $default_options) {
    ...
    elseif (!empty($default_options['prefix'])) {
    ...
    elseif (isset($default_options['fast_cache'])) {
      $this->fast_cache = $default_options['fast_cache'];
    }
    ...
    elseif (isset($default_options['static'])) {
  ...
  function garbage_collection() {
    // Do nothing. Child classes may want to do something.
  }
