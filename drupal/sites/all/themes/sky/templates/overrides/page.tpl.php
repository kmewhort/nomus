    ...
    <div id="container" class="layout-region">
      <?php if ($left): ?>
        <div id="sidebar-left" class="sidebar">
          <div class="inner">
            <?php if ($logo): ?>
              <div id="block-logo" class="block block-odd clearfix">
                <div class="content">
      ...
      <div id="main">
        <div class="main-inner">
          <?php if($user->uid): ?>
            <div id="logout-link"><a href="<?php print base_path(); ?>logout">Logout</a></div>
          <?php endif; ?>
          <?php if ($breadcrumb){ ?>
         ...
         <?php if ($show_messages && $messages != ""): ?>
          ...
          <?php endif; ?>
          <?php print $tabs; ?>
          <?php if ($contentbelowtop): ?>
            <div id="content-below-top">
            	<div id="content-below-top-container">
            	<?php print $contentbelowtop; ?>
            	</div>
